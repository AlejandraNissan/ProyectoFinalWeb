...
El proyecto cuenta con una base de datos la cual la tenemos en MongoDB. Los datos que manejamos que están en la base de datos son la información de cada libro. En el código manejamos las peticiones a la base de datos con add. Utilizamos html, css, javascript y express.
